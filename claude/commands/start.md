...
2. Call `ruvex_my_tasks` and take the FIRST task automatically (server sorts by
   in-progress, critical, priority). Tell the user which task was picked and for which
   project.
